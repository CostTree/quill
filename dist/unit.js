...
var Quill = function () {
  ...
  function Quill(container) {
    ...
    this.emitter = new _emitter4.default(this.container);
  ...
  EVENTS.forEach(function (eventName) {
    dom.addEventListener(eventName, function () {
      if (dom.__quill && dom.__quill.emitter) {
        var _dom$__quill$emitter;

        (_dom$__quill$emitter = dom.__quill.emitter).handleDOM.apply(_dom$__quill$emitter, arguments);
      }
    });
  });
}
...
var Emitter = function (_EventEmitter) {
  ...
  function Emitter() {
    ...
    if (_this.dom) {
      registerDOMListeners(_this.dom);
    }
    return _this;
  }
...
var Selection = function () {
  function Selection(scroll, emitter) {
    ...
    this.handleDragging();
    this.emitter.listenDOM('selectionchange', this.root, function () {
      if (!_this.mouseDown) {
  ...
  _createClass(Selection, [{
    ...
    value: function handleDragging() {
      ...
      this.emitter.listenDOM('mousedown', this.root, function () {
        _this3.mouseDown = true;
      });
      this.emitter.listenDOM('mouseup', this.root, function () {
    ...
    value: function getNativeRange() {
      var selection = this.domRoot.getSelection();
...
function initialize(klass, html) {
  ...
  var emitter = new _emitter2.default(container);
